  ...
  return (
    <>
      ...
      <div class="flex justify-center">
        <div class="py-6 px-8 h-100 mt-20 bg-white rounded shadow-xl">
          <form onSubmit={submitHandler}>
            <div class="mb-2">
              <label for="name" class="block text-rose-800 font-bold">
                Name:
              </label>
              <input
                type="text"
                ...
                class="w-full border border-rose-300 py-2 pl-3 rounded mt-2 outline-none"
                onChange={(e) =>
            ...
            <div class="mb-2">
              <label for="email" class="block text-rose-800 font-bold">
                Email:
              </label>
              <input
                type="text"
            ...
            <div class="mb-2">
              <label for="password" class="block text-rose-800 font-bold">
                Password:
              </label>
              <input
                type="password"
            ...
            <button
              type="submit"
              class="cursor-pointer py-2 px-4 block mt-6 bg-rose-500 text-white font-bold w-full text-center rounded hover:bg-rose-300 hover:text-rose-600"
            >
              Signup
            </button>
          </form>
